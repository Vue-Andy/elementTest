  ...
  <div id="app">
    <el-container>
      ...
      <el-container style='display:flex;position:absolute;bottom:60px;top:60px;left:0;right:0;'>
        ...
        <!-- <transition name='el-zoom-in-center'>
          <el-menu router v-show='isSpread'>
            <el-menu-item v-for='item in menuList' :key='item.id' :index='item.path' :class='{routeItem:item.path,subMenuItem:!item.path}'>{{item.name}}</el-menu-item>
          </el-menu>
        </transition> -->
